...
Elm.GameOfLife.make = function (_elm) {
            ...
            return A3($Graphics$Collage.collage,
              ...
              function (_v4) {
                 return function () {
                    ...
                    {case "_Tuple2": return _v4._1;}
                    _U.badCase($moduleName,
                    "on line 194, column 34 to 38");
                 }();
              },
              $Dict.values(game.board)));}
         _U.badCase($moduleName,
         "between lines 193 and 194");
      }();
   });
   var channelTileUpdate = $Signal.channel($Maybe.Nothing);
            ...
            return A2($Maybe.andThen,
              ...
              function (_v12) {
                 return function () {
                    switch (_v12.ctor)
                    {case "_Tuple2":
                       return _v12._0 ? _v8._0 : _v8._1;}
                    _U.badCase($moduleName,
                    "on line 117, column 23 to 56");
                 }();
              });}
         _U.badCase($moduleName,
   ...
   var tileWillLive = F3(function (pos,
   dict,
   _v20) {
      return function () {
         switch (_v20.ctor)
              ...
              function (_v24) {
                 return function () {
                    return function () {
                       ...
                       pos,
                       dict);
                       return _U.cmp(aliveTilesAround,
                       _v20._0) > -1 && _U.cmp(aliveTilesAround,
                       _v20._1) < 1 ? $Maybe.Just(true) : $Maybe.Just(false);
                    }();
                 }();
              });}
         _U.badCase($moduleName,
   ...
   var getElementAt = F2(function (_v26,
   shapeFilled) {
      return function () {
         switch (_v26.ctor)
         {case "_Tuple2":
            return function () {
                 ...
                 var posY = tilePosYDir(_v26._1);
                 var posX = tilePosXDir(_v26._0);
                 ...
                 $Maybe.Just({ctor: "_Tuple2"
                             ,_0: _v26._0
                             ,_1: _v26._1})))(A2($Graphics$Collage.collage,
                 tileSize,
   ...
   var defaultGame = {_: {}
                     ,board: emptyBoard
                     ,state: Paused};
   var updateFromClick = F2(function (action,
   game) {
      return function () {
         switch (action.ctor)
         {case "Just":
   ...
   updateFromClick,
   defaultGame,
   $Signal.subscribe(channelTileUpdate)));
   _elm.GameOfLife.values = {_op: _op
                            ...
                            ,updateFromClick: updateFromClick

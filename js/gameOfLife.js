...
Elm.GameOfLife.make = function (_elm) {
   ...
   $List = Elm.List.make(_elm),
   $ListExtension = Elm.ListExtension.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Time = Elm.Time.make(_elm),
   $Window = Elm.Window.make(_elm);
   var updateState = F2(function (newState,
   game) {
      return _U.replace([["state"
                         ,newState]],
      game);
   });
   var tileLivesAndThen = F3(function (key,
   dict,
   _v0) {
      return function () {
         switch (_v0.ctor)
            ...
            return A2($Maybe.andThen,
              ...
              function (_v4) {
                 return function () {
                    switch (_v4.ctor)
                    {case "_Tuple2":
                       return _v4._0 ? _v0._0 : _v0._1;}
                    _U.badCase($moduleName,
                    "on line 126, column 23 to 56");
                 }();
              });}
         _U.badCase($moduleName,
   ...
   var GameState = function (a) {
      return {ctor: "GameState"
             ,_0: a};
   };
   var Tile = function (a) {
      return {ctor: "Tile",_0: a};
   };
   var channelTileUpdate = $Signal.channel(Tile($Maybe.Nothing));
   var Playing = {ctor: "Playing"};
   var Paused = {ctor: "Paused"};
   var channelPlayPause = $Signal.channel(GameState(Paused));
   ...
   game) {
      return function () {
         ...
         {case "_Tuple2":
            return function () {
                 var playButtonStyle = $Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                                            ,_0: "width"
                                                                            ,_1: "50px"}
                                                                           ,{ctor: "_Tuple2"
                                                                            ,_0: "height"
                                                                           ...
                                                                           ,{ctor: "_Tuple2"
                                                                            ,_0: "cursor"
                                                                            ,_1: "pointer"}]));
                 var playing = _U.eq(game.state,
                 Playing);
                 var buttonSymbol = playing ? "II" : ">";
                 var newGameState = playing ? GameState(Paused) : GameState(Playing);
                 var playButton = A2($Html.div,
                 _L.fromArray([playButtonStyle
                              ,$Html$Events.onClick(A2($Signal.send,
                              channelPlayPause,
                              newGameState))]),
                 _L.fromArray([$Html.text(buttonSymbol)]));
                 var gameOffsetYDir = (_v8._1 - gameHeight) / 2 | 0;
                 var sideBarStyle = $Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                                         ,_0: "width"
                                                                         ,_1: "150px"}
                                                                        ,{ctor: "_Tuple2"
                                                                         ,_0: "height"
                                                                         ,_1: A2($Basics._op["++"],
                                                                         $Basics.toString(gameHeight),
                                                                         "px")}
                                                                        ,{ctor: "_Tuple2"
                                                                         ,_0: "padding-left"
                                                                         ,_1: "25px"}
                                                                        ,{ctor: "_Tuple2"
                                                                         ,_0: "margin-top"
                                                                         ,_1: A2($Basics._op["++"],
                                                                         $Basics.toString(gameOffsetYDir),
                                                                         "px")}]));
                 var sideBar = A2($Html.toElement,
                 150,
                 gameHeight)(A2($Html.div,
                 _L.fromArray([sideBarStyle]),
                 _L.fromArray([playButton])));
                              ...
                              function (_v12) {
                                 return function () {
                                    ...
                                    {case "_Tuple2":
                                       return _v12._1;}
                                    _U.badCase($moduleName,
                                    "on line 224, column 42 to 46");
                                 }();
                              },
                              $Dict.values(game.board)))]));
              }();}
         _U.badCase($moduleName,
         "between lines 196 and 225");
      }();
   });
   var gameWidth = 600;
   var tileColorOff = $Color.green;
   var tileColorOn = $Color.black;
   var tileGap = 1;
   var tileSize = 14;
   var tileNumberXDir = gameWidth / tileSize | 0;
   var tileNumberYDir = gameHeight / tileSize | 0;
   var tileNeighbours = function (_v16) {
      return function () {
         switch (_v16.ctor)
         {case "_Tuple2":
            return function () {
                 ...
                 0) > 0 ? _U.cmp(_v16._1,
                 0) > 0 ? _U.cmp(_v16._0,
                 tileNumberXDir) < 0 ? _U.cmp(_v16._1,
                 tileNumberYDir) < 0 ? _L.fromArray([{ctor: "_Tuple2"
                                                     ,_0: px
                                                     ,_1: py}
                                                    ,{ctor: "_Tuple2"
                                                     ,_0: px
                                                    ...
                                                    ,{ctor: "_Tuple2"
                                                     ,_0: sx
                                                     ,_1: sy}]) : _L.fromArray([{ctor: "_Tuple2"
                                                                                ,_0: px
                                                                                ,_1: py}
                                                                               ,{ctor: "_Tuple2"
                                                                                ,_0: px
                 ...
                 tileNumberYDir) < 0 ? _L.fromArray([{ctor: "_Tuple2"
                                                    ...
                                                    ,{ctor: "_Tuple2"
                                                     ...
                                                     ,_1: sy}]) : _L.fromArray([{ctor: "_Tuple2"
                                                                               ...
                                                                               ,{ctor: "_Tuple2"
                                                                                ,_0: _v16._0
                                                                                ,_1: py}]) : _U.cmp(_v16._0,
                 tileNumberXDir) < 0 ? _L.fromArray([{ctor: "_Tuple2"
                                                     ,_0: px
                                                     ,_1: _v16._1}
                                                    ,{ctor: "_Tuple2"
                                                     ,_0: px
                 ...
                 tileNumberYDir) < 0 ? _L.fromArray([{ctor: "_Tuple2"
                                                    ...
                                                    ,{ctor: "_Tuple2"
                                                     ...
                                                     ,_1: sy}]) : _L.fromArray([{ctor: "_Tuple2"
                                                                               ...
                                                                               ,{ctor: "_Tuple2"
                                                                                ,_0: sx
                                                                                ,_1: _v16._1}]) : _L.fromArray([{ctor: "_Tuple2"
                                                                                                                ,_0: _v16._0
                                                                                                                ,_1: sy}
                                                                                                               ,{ctor: "_Tuple2"
                                                                                                                ,_0: sx
         ...
         _U.badCase($moduleName,
         "between lines 88 and 120");
      }();
   };
   var getAliveTilesAround = F2(function (pos,
   dict) {
      return $List.sum(A2($List.filterMap,
      function (pos$) {
         return A3(tileLivesAndThen,
         pos$,
         dict,
         {ctor: "_Tuple2"
         ,_0: $Maybe.Just(1)
   ...
   var tileWillLive = F3(function (_v20,
   pos,
   dict) {
      return function () {
         switch (_v20.ctor)
         {case "_Tuple3":
            return A2($Maybe.andThen,
              A2($Dict.get,pos,dict),
              function (_v25) {
                 return function () {
                    switch (_v25.ctor)
                    {case "_Tuple2":
                       return function () {
                            var aliveTilesAround = A2(getAliveTilesAround,
                            pos,
                            dict);
                            return _v25._0 ? _U.cmp(aliveTilesAround,
                            _v20._0) > 0 && _U.cmp(aliveTilesAround,
                            _v20._1) < 0 ? $Maybe.Just(true) : $Maybe.Just(false) : _U.eq(aliveTilesAround,
                            _v20._2) ? $Maybe.Just(true) : $Maybe.Just(false);
                         }();}
                    _U.badCase($moduleName,
   ...
   var tileWillLiveConway = tileWillLive({ctor: "_Tuple3"
                                         ,_0: 1
                                         ,_1: 3
                                         ,_2: 3});
   var tilePosXDir = function (n) {
      return function () {
         var tileOffsetXDir = gameWidth / 2 | 0;
         return $Basics.toFloat(n * (tileSize + tileGap) - tileOffsetXDir);
      }();
   };
   var tilePosYDir = function (n) {
      return function () {
         var tileOffsetYDir = gameHeight / 2 | 0;
         return $Basics.toFloat(n * (tileSize + tileGap) - tileOffsetYDir);
      }();
   };
   var getElementAt = F2(function (_v29,
   shapeFilled) {
      return function () {
         switch (_v29.ctor)
         {case "_Tuple2":
            return function () {
                 var shapeStyle = function () {
                    switch (shapeFilled)
                    {case false:
                       return $Graphics$Collage.filled(tileColorOff);
                       case true:
                       return $Graphics$Collage.filled(tileColorOn);}
                    _U.badCase($moduleName,
                    "between lines 183 and 186");
                 }();
                 var tileSizeFloat = $Basics.toFloat(tileSize);
                 var posY = tilePosYDir(_v29._1);
                 var posX = tilePosXDir(_v29._0);
                 return $Graphics$Collage.move({ctor: "_Tuple2"
                                               ,_0: posX
                                               ,_1: posY})($Graphics$Collage.toForm($Graphics$Input.clickable(A2($Signal.send,
                 channelTileUpdate,
                 Tile($Maybe.Just({ctor: "_Tuple2"
                                  ,_0: _v29._0
                                  ,_1: _v29._1}))))(A2($Graphics$Collage.collage,
                 tileSize,
                 tileSize)(_L.fromArray([shapeStyle(A2($Graphics$Collage.rect,
                 tileSizeFloat,
                 tileSizeFloat))])))));
              }();}
         _U.badCase($moduleName,
         "between lines 177 and 192");
      }();
   });
   var emptyBoard = $Dict.fromList($List.map(function (pos) {
      return {ctor: "_Tuple2"
             ,_0: pos
             ,_1: {ctor: "_Tuple2"
                  ,_0: false
                  ...
                  pos,
                  false)}};
   })(A3($ListExtension.cartesianProduct,
   F2(function (v0,v1) {
      return {ctor: "_Tuple2"
             ,_0: v0
             ,_1: v1};
   }),
   _L.range(0,tileNumberXDir),
   _L.range(0,tileNumberYDir))));
   var defaultGame = {_: {}
                     ,board: emptyBoard
                     ,state: Paused};
   var updateTile = F2(function (pos,
   game) {
      return function () {
         var updateVal = function (value) {
            return function () {
               switch (value.ctor)
               {case "Just":
                  switch (value._0.ctor)
                    {case "_Tuple2":
                       return $Maybe.Just({ctor: "_Tuple2"
                                          ,_0: $Basics.not(value._0._0)
                                          ,_1: A2(getElementAt,
                                          pos,
                                          $Basics.not(value._0._0))});}
                    break;}
               return $Maybe.Nothing;
            }();
         };
   ...
   var updateBoard = function (game) {
      return function () {
         var newBoard = A2($Dict.map,
         F2(function (pos,val) {
            return function () {
               var _v38 = A2(tileWillLiveConway,
               pos,
               game.board);
               switch (_v38.ctor)
               {case "Just":
                    ...
                    switch (action._0._0.ctor)
                      {case "_Tuple0":
                         return _U.eq(game.state,
                           Playing) ? updateBoard(game) : game;}
                      break;}
                 break;
               case "Tile":
               switch (action._0.ctor)
                 {case "Just":
                    return A2(updateTile,
                      action._0._0,
                      game);}
                 break;}
            return game;
   ...
   updateGame,
   defaultGame,
   $Signal.mergeMany(_L.fromArray([$Signal.subscribe(channelTileUpdate)
                                  ,$Signal.subscribe(channelPlayPause)
                                  ,A2($Signal._op["<~"],
                                  function (time) {
                                     return Tick($Maybe.Just({ctor: "_Tuple0"}));
                                  },
                                  $Time.fps(0.5))]))));
   _elm.GameOfLife.values = {_op: _op
                            ,tileSize: tileSize
                            ,tileGap: tileGap
                            ,tileColorOn: tileColorOn
                            ,tileColorOff: tileColorOff
                            ,gameWidth: gameWidth
                            ,gameHeight: gameHeight
                            ,tileNumberXDir: tileNumberXDir
                            ,tileNumberYDir: tileNumberYDir
                            ,Game: Game
                            ,Paused: Paused
                            ,Playing: Playing
                            ,Tile: Tile
                            ...
                            ,tileLivesAndThen: tileLivesAndThen
                            ,getAliveTilesAround: getAliveTilesAround
                            ,tileWillLive: tileWillLive
                            ,tileWillLiveConway: tileWillLiveConway
                            ,tilePosXDir: tilePosXDir
                            ,tilePosYDir: tilePosYDir
                            ,getElementAt: getElementAt
                            ,display: display
                            ,channelTileUpdate: channelTileUpdate
                            ,channelPlayPause: channelPlayPause
...
Elm.ListExtension = Elm.ListExtension || {};
Elm.ListExtension.make = function (_elm) {
   "use strict";
   _elm.ListExtension = _elm.ListExtension || {};
   if (_elm.ListExtension.values)
   return _elm.ListExtension.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _P = _N.Ports.make(_elm),
   $moduleName = "ListExtension",
   $List = Elm.List.make(_elm);
   ...
   _elm.ListExtension.values = {_op: _op
